...
<body>
  <div id="container">
    ...
    <p>
      This is fhchaos, <a href="http://www.felixmiddendorf.eu/">Felix'</a> and
      <a href="http://www.sperker.de">Hans'</a> little server that just runs and runs
      and runs. Thanks to the fine folks at
     <a rel="nofollow" href="http://www.debian.org/">Debian</a>.
    </p>
<?php if(isSet($links) && (count($links) > 0)): ?>
    <h2>Where am I?</h2>
    <p>
      You probably did not want to go to this site, right?
